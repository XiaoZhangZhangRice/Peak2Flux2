...
#' Creates calibration curves using gas standards of known concentrations.
#'
#' @param standard_data A data frame with peak area values of gas standards that are sorted by gas chromatography runs
#' @return Data frame containing parameters of the calibration curve
#' @export
#' @examples
...
#' Converts gas chromatograph peak area output to concentration
#'
#' Creates calibration curves using gas standards per GC run in order to determine sample concentration values
#'
#' @param standard_data A data frame with peak area values of gas standards that are sorted by gas chromatography runs
#' @param sample_data A data frame with peak area values of gas samples that are sorted by gas chromatography runs
#' @param r_square_threshold Integer. Defines the r2 values the user would like for the calibration curve generated by gas standards
#' @return Data frame containing calculated sample gas concentrations (ppm)
#' @importFrom dplyr %>%
#' @export
#' @examples
